...
secNav.querySelectorAll('a').forEach(function (a) {
...
touchLis_li.onmouseover = function () {
  sec_category.style.display = 'block'; // console.log(touchLis_li);
};
...
touchLis_li.forEach(function (li) {
  li.onmouseover = function () {
    console.log(li);

    for (var i = 0; i < touchLis_li.length; i++) {
